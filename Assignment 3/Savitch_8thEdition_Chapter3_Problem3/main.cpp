 ...
 * Created on January 19, 2014, 2:02 AM
 * Savitch, 8th Edition - Chapter 3, Problem 3
 * Astrology program - takes 2 user inputs (
 * birth month & birth day, both numeric) and uses
 * a whole lotta if's to determine which astrological
 * sign the user entered. It then prints a one-line
 * horoscope for the user. Program will also check for
 * cusps.
 */
...
int main(int argc, char** argv) {
    ...
    if (julDate) {
        ...
        //Capricorn spans year end, so the date check is a little different
            ...
            cout << "Aquarius:" << endl << AQU_HOR << endl;
