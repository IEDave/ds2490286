 ...
 * Problem #8 - Ask user for the number of nickels, dimes & quarters
...
int main(int argc, char** argv){
    ...
    int usrNckl, usrDime, usrQtr, cnv2Bux, dspDols, dspCnts;
    float totAmt;
    //Get User Input
    ...
    // Output result - to get dollars & cents to display correctly
    // without using formatting tools, we're going to get a bit cute.
    ...
    cout << "With (" << usrNckl << ") nickels, ("
         ...
         << dspDols << "." << dspCnts / 10 << dspCnts % 10 << endl;
